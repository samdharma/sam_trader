...
# TrdMarket name string → int (handles SDK v10.6+ string serialisation)
FUTU_TRD_MARKET_NAME_TO_INT: dict[str, int] = {
    "HK": FUTU_TRD_MARKET_HK,
    "US": FUTU_TRD_MARKET_US,
    "CN": FUTU_TRD_MARKET_CN,
    "HKCC": FUTU_TRD_MARKET_HKCC,
    "FUTURES": FUTU_TRD_MARKET_FUTURES,
    "SG": FUTU_TRD_MARKET_SG,
    "CRYPTO": FUTU_TRD_MARKET_CRYPTO,
    "AU": FUTU_TRD_MARKET_AU,
    "JP": FUTU_TRD_MARKET_JP,
    "CA": FUTU_TRD_MARKET_CA,
    "MY": FUTU_TRD_MARKET_MY,
    "HKFUND": FUTU_TRD_MARKET_HKFUND,
    "USFUND": FUTU_TRD_MARKET_USFUND,
    "SGFUND": FUTU_TRD_MARKET_SGFUND,
    "MYFUND": FUTU_TRD_MARKET_MYFUND,
    "JPFUND": FUTU_TRD_MARKET_JPFUND,
}
